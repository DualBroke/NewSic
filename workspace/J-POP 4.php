...
<body>
    ...
    <div class="recommand_page">
        <h1 class="main_title">Yuuri(키무라 유우리)</h1>

        <section class="artist_section">
            <div class="artist_photo">
                <img src="./images/Yuuri.webp" alt="artist photo">
            </div>

            <div class="artist_info">
                <p class="info_text">
                    출생: 1994년 3월 23일<br>
                    데뷔: 2019년 12월 1일 - 숨바꼭질(かくれんぼ)<br>
                    레이블: Ariola Japan<br>
                    특징:
                </p>

                <ul class="member_list">
                    <li>이별 노래 장인. 전 여친을 못 잊는 가사가 많음</li>
                    <li>2016년 록밴드 THE BUGZY의 보컬로 활동하다가 2019년 5월 해산 이후 솔로 데뷔하여 큰 성과를 거둠</li>
                </ul>
        ...
        <section class="songs_section">
            <div class="song_item">
                <div class="song_photo" data-song="betelgeuse">
                    <img src="./images/Betelgeuse.png" alt="Song 1 Image">
                    <audio class="song-audio">
                        <source
                            src="./audio/백 년을 지나 도착한 별빛처럼⭐️ 유우리 - 베텔기우스(BETELGEUSE) [가사발음한글 자막.mp3"
                            type="audio/mpeg">
                    </audio>
                </div>
                <div class="song_info">
                    <p>
                        <b><a href="https://youtu.be/cbqvxDTLMps?si=R15_hPVr9Py-feAx" target="_blank"
                                class="song-title-link">Betelgeuse</a></b><br><br>
                        한국에서 유우리를 가장 유명하게 만든 곡이다. 숏폼에서 한 번쯤 들어봤을 것이다. 별자리와 사람의 인연을 엮은 가사가 정말 예쁘다.
                    </p>
                </div>
            </div>

            <div class="song_item">
                <div class="song_photo" data-song="billimillion">
                    <img src="./images/Billimillion.png" alt="Song 2 Image">
                    <audio class="song-audio">
                        <source src="./audio/優里『ビリミリオン』Official Music Video (mp3cut.net).mp3" type="audio/mpeg">
                    </audio>
                </div>
                <div class="song_info">
                    <p>
                        <b><a href="https://youtu.be/vUsikBoa8i0?si=w4RIs84F-aRV4Hbx" target="_blank"
                                class="song-title-link">Billimillion</a></b><br><br>
                        "남은 수명을 100억 원에 팔래?"라고 물으면 안 판다고 하겠지? 그만큼 너의 삶은 100억보다 가치 있다는 내용의 노래다.
                    </p>
                </div>
            </div>

            <div class="song_item">
                <div class="song_photo" data-song="natsune">
                    <img src="./images/Natsune.png" alt="Song 3 Image">
                    <audio class="song-audio">
                        <source src="./audio/Natsune (mp3cut.net).mp3" type="audio/mpeg">
                    </audio>
                </div>
                <div class="song_info">
                    <p>
                        <b><a href="https://youtu.be/FVGRHm_NWu0?si=9CcITHUCSDAn0a1W" target="_blank"
                                class="song-title-link">Natsune</a></b><br><br>
                        '드라이 플라워'의 감성을 좋아한다면 무조건 들어야 할 곡이다. 제목이 '여름 소리'라는 뜻인데, 여름밤의 습한 공기와 짝사랑의 애틋함이 그대로 느껴진다.
                    </p>
                </div>
            </div>

            <div class="song_item">
                <div class="song_photo" data-song="peterpan">
                    <img src="./images/Peter Pan.png" alt="Song 4 Image">
                    <audio class="song-audio">
                        <source src="./audio/「JPOP」 어른 아이에서 동화같은 해피엔딩을 위해  피터팬(ピーターパン) - 유우리(優里)  [발음ᄀ.mp3"
                            type="audio/mpeg">
                    </audio>
                </div>
                <div class="song_info">
                    <p>
                        <b><a href="https://youtu.be/9qfPF4fpiHE?si=wcf2K781RR5-2F_-" target="_blank"
                                class="song-title-link">Peter Pan</a></b><br><br>
                        슬픈 발라드만 있는 게 아니다. 이건 아침에 듣기 좋은 엄청 신나는 응원가이다. '어른이 되지 않아도 괜찮아, 네 마음대로 살아'라고 등을 밀어주는 느낌이다.
                    </p>
                </div>
            </div>
