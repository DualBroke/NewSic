<?php
    ...
    if ($conn){
        ...
        if (!$myDB){
            ...
            $qry .= " VALUES( 13, '솔로', '싸이', '2001.01.12', 'P NATION', '현역', '대한민국', '댄스', '강남스타일')";
            $qry .= " ,( 14, '그룹', '빅뱅', '2006.08.19', '前YG엔터테인먼트', '현역', '대한민국', '댄스, 랩', '뱅뱅뱅')";
            $qry .= " ,( 15, '솔로', '비욘세', '2003. (솔로)', '파크우드 엔터테인먼트', '현역', '미국', '팝', 'Crazy In Love')";
